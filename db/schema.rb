...
ActiveRecord::Schema[7.0].define(version: 2022_05_06_030547) do
  ...
  create_table "item_carts", force: :cascade do |t|
    t.string "item_cartable_type", null: false
    t.bigint "item_cartable_id", null: false
    t.integer "quantity"
    t.bigint "cart_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cart_id"], name: "index_item_carts_on_cart_id"
    t.index ["item_cartable_type", "item_cartable_id"], name: "index_item_carts_on_item_cartable"
  end
